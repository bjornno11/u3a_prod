"""
Django settings for u3a project.
...
SECRET_KEY = 'django-insecure-_gjcgir%m1)(9_l@v69owkzwou%3lfbk&j(xzxy*7!2g@03*zk'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

# Kritiske sikkerhetsheadere (anbefalt)
...
MIDDLEWARE = [
    ...
    'lag.middleware.SidevisningMiddleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # Global malmappe
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'u3a.wsgi.application'
...
STATIC_URL = 'static/'
# STATIC_ROOT skal peke til mappen du bruker til å betjene statiske filer
